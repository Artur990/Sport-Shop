...
const Silownia = () => (
  <div className="main-gym">
    ...
    <div className="plans-gym__sections">
      ...
      <h3>
        Planując regularne wizyty w sali ćwiczeń, trzeba dać organizmowi czas na
        zaadaptowanie się do nowych warunków. Ciało musi przywyknąć do wysiłku,
        a mięśnie, stawy i więzadła muszą mieć czas, aby się uodpornić.
        Najlepsze ćwiczenia dla początkujących to, np.:
      </h3>
      <ul>
        ...
        <li>unoszenie sztangielek bokiem w górę – 4 serie po 15 powtórzeń,</li>
        <li>unoszenie sztangielek bokiem w górę – 4 serie po 15 powtórzeń,</li>
      </ul>
    ...
    <div className="plans-gym__sections">
      ...
      <h3>
        ...
        należy dopasować do własnych możliwości. Przerwy w treningu powinny być
        dostosowane do celu treningowego.
      </h3>
      <h4>
      ...
      <ul>
        ...
        <li>
          Mięśnie pleców – przyciąganie drążka wyciągu górnego, 3 serie po 8-12
          powtórzeń.
        </li>
        <li>Nogi – przysiady, 3 serie po 8-12 powtórzeń.</li>
        <li>Barki – wyciskanie sztangi siedząc, 2 serie po 8-12 powtórzeń.</li>
        <li>
          Biceps – uginanie ramion z hantlami stojąc, 2 serie po 8-12 powtórzeń.
        </li>
        <li>
